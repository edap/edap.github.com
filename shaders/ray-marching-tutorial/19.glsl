...
float map(vec3 pos){
    ...
    float sRadius = 3.5;
    float s3 = bendTorus(pos - s3pos,vec2(sRadius+0.5, 0.5)); //2.5
    float s4 = bendTorus(pos - s4pos,vec2(sRadius-1.2, 0.5)); //2.5
    float s5 = bendTorus(pos - s5pos,vec2(sRadius-1., 0.5)); //2.5
