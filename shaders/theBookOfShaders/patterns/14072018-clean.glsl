...
void main (void) {
  ...
  vec3 red = vec3(0.898, 0.341, 0.178);
  //anim para
  float growCol = sin(iGlobalTime* 1.2);
  ...
  vec3 sepalsColor = mix(red, rose,sin((angle+0.1)*100.)+0.9);
  ...
  vec3 latPetalsColor = mix(red,rose, sin(angle * 40.0));
