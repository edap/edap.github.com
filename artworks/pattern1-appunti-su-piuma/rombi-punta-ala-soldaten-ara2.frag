...
void main(void){
  ...
  vec3 coloreDue = vec3(0.702, 0.839, 0.38);
  vec3 coloreTre = vec3(0.945, 0.757, 0.137);
  vec3 coloreQuattro = vec3(0.902, 0.659, 0.141);
  vec3 coloreCinque = vec3(0.525, 0.094, 0.949);
  ...
  vec3 colorStripes = mix(coloreUno * tex.r, coloreDue, offset);
